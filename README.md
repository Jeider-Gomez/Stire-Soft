...
| Documento | Contenido |
|-----------|-----------|
| [`MONITOREO_SEMANAL.md`](./MONITOREO_SEMANAL.md) | Bitácora oficial del curso, **en curso** (Semana 6, 21-25 sep): avances, cuellos de botella y compromisos de la semana. |

...
declare global {
  ...
  const useTutorStore: typeof import('../../stores/tutor').useTutorStore
...
declare global {
  ...
  // @ts-ignore
  export type { EnrolledClassInfo } from '../../stores/student'
  import('../../stores/student')
  // @ts-ignore
  export type { WorkspaceExercise, WorkspaceQuestion } from '../../stores/workspace'
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly useTutorStore: UnwrapRef<typeof import('../../stores/tutor')['useTutorStore']>

import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///app/applet/frontend-nuxt/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { getResponseStatusText, getResponseStatus, getQuery, createError, appendResponseHeader } from 'file:///app/applet/frontend-nuxt/node_modules/h3/dist/index.mjs';
import { joinRelativeURL, encodePath, joinURL } from 'file:///app/applet/frontend-nuxt/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///app/applet/frontend-nuxt/node_modules/vue/server-renderer/index.mjs';
...
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///app/applet/frontend-nuxt/node_modules/unhead/dist/server.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///app/applet/frontend-nuxt/node_modules/devalue/index.js';
import { walkResolver } from 'file:///app/applet/frontend-nuxt/node_modules/unhead/dist/utils.mjs';
import { isRef, toValue, hasInjectionContext, inject, getCurrentScope, ref, watchEffect, getCurrentInstance, onBeforeUnmount, onDeactivated, onActivated } from 'file:///app/applet/frontend-nuxt/node_modules/vue/index.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///app/applet/frontend-nuxt/node_modules/unhead/dist/plugins.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Sistema Tutor Inteligente con Repetición Espaciada y Evaluación Automática"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"STIRE-Soft — Sistema Tutor Inteligente","htmlAttrs":{"lang":"es"}};

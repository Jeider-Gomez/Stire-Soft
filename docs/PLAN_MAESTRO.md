...
### 6.1 Antigravity — Fase 22 pendiente; Fase 21 entregada y auditada; Fases 18 a 20 con auditoría parcial

**Vigente: Fase 22**, escrita el 20/09 en `docs/antigravity/PLAN_IMPLEMENTACION.md`: cuatro correcciones que
salieron de auditar la Fase 21 en navegador real. **T1** aviso de repasos y «Ir al contenido» también sin clave
de Google guardada; **T2** Escape y foco (panel del Tutor y diálogo de limpieza); **T3** no arrastrar el contenido
de la actividad anterior al inicio; **T4** estados «✔» fijos en `ADM-V01`. Sin ejecutar.

...
* [~] **BYOK (Bring Your Own Key):** ~~Interfaz para que estudiantes avanzados ingresen su propia clave~~ — **adelantado a núcleo del Tutor el 2026-09-19** (ADR 10): backend implementado (`/tutor/api-key`, AES-256-GCM); la interfaz (registro con opción de omitir + panel en el chat) está en `docs/_archivo/PLAN_IMPLEMENTACION_ANTIGRAVITY_2026-09-20.md` §19.

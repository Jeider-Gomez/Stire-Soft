---
estado:     HISTÓRICO — Fase 23 entregada, auditada y fusionada a main (commit 0397d02, 22/09)
verificado: 2026-09-22 por Claude Code contra frontend-nuxt/ y src/ reales (no solo contra el informe de Antigravity)
fuente:     archivo (ya no es el plan vigente de Antigravity)

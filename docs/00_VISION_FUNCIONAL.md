...
|---|---|---|
| Proveedor y clave | Solo Google Gemini, con la **clave gratuita de Google AI Studio de cada estudiante** (se pide en el registro con opción de omitir, o al primer uso del Tutor, con los pasos para conseguirla). Se retira OpenAI y la respuesta simulada de reserva. | Backend ✅ (ADR 10). Interfaz: `docs/antigravity/PLAN_IMPLEMENTACION.md` §19. |
...
| Experiencia del chat (errores legibles, accesibilidad, scroll, Markdown, espera, móvil, historial visible) | Se delega a Antigravity. | `docs/antigravity/PLAN_IMPLEMENTACION.md` §18. |

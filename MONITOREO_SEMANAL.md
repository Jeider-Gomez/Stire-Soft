...
**Tablero Kanban:** https://trello.com/b/ANRr4Uff/stire-kanban-desarrollo-semana-04-7-11-sep-2026

> **Regla de trabajo:** Trello contiene el flujo operativo y los checklists. GitHub contiene el código y las evidencias técnicas. Esta bitácora registra el resultado real de la semana y se actualiza durante el sprint sin duplicar el detalle de las tarjetas.
...
- [ ] **S04-J02 · Implementar Ventana Estándar** — objetivo 10/09.
- [ ] **S04-J03 · Cerrar brechas críticas backend** — objetivo 11/09.

**Dependencias principales:** S04-J02 depende de S04-J01. S04-J03 puede ejecutarse en paralelo.

### Pedro Romero — Gestión + Documentación + Apoyo Técnico

- [ ] **S04-P01 · Organizar Sprint y Trello** — objetivo 07/09.
- [ ] **S04-P02 · Apoyar componentes frontend** — objetivo 10/09.
- [ ] **S04-P03 · Bitácora y cierre semanal** — objetivo 11/09.

**Dependencias principales:** S04-P02 depende de S04-J01. S04-P03 depende de las evidencias y resultados del equipo.

### José López — UI/UX + Comunicación

- [ ] **S04-JO01 · Validar UI contra Figma** — objetivo 10/09.
- [ ] **S04-JO02 · Preparar Pitch de avances** — objetivo 11/09.
- [ ] **S04-JO03 · Revisar material visual** — objetivo 11/09.

**Dependencias principales:** S04-JO01 depende de S04-J02. S04-JO02 y S04-JO03 dependen de los avances y evidencias reales del equipo.

### Julio Galvis — Diseño Instruccional

- [ ] **S04-JL01 · Validar navegación de estudiante** — objetivo 09/09.
- [ ] **S04-JL02 · Preparar contenidos pendientes** — objetivo 10/09.
- [ ] **S04-JL03 · Validación pedagógica** — objetivo 11/09.

**Dependencias principales:** S04-JL01 y S04-JL02 pueden ejecutarse en paralelo. S04-JL03 depende de que exista una vista funcional para probar el flujo.

### Jorge Cervantes — Calidad y Pruebas

- [ ] **S04-JOR01 · Pruebas funcionales** — objetivo 11/09.
- [ ] **S04-JOR02 · Revisar calidad del frontend** — objetivo 11/09.
- [ ] **S04-JOR03 · Revisión final de entregables** — objetivo 11/09.

**Dependencias principales:** S04-JOR01 depende de las correcciones críticas del backend. S04-JOR02 depende de S04-J02. S04-JOR03 depende de los entregables del equipo.
...
```text
📥 BACKLOG → 📋 POR HACER → ⚙️ HACIENDO → 👀 REVISIÓN → ✅ HECHO
                                      ↘
                                       🚧 BLOQUEADO
```
...
1. Máximo **3 tarjetas comprometidas por persona**.
2. Máximo **2 tarjetas simultáneas en HACIENDO por persona**.
3. Toda dependencia debe estar escrita en la descripción de la tarjeta.
4. Una tarjeta bloqueada pasa a `🚧 BLOQUEADO` y debe indicar la causa.
5. Una tarea no pasa a `✅ HECHO` sin evidencia.
6. El código terminado debe tener commit en GitHub.
7. Las tareas operativas permanecen en Trello; la bitácora no duplica los checklists.

---

## ⚠️ 5. Riesgos y pendientes heredados

1. **Nuxt:** era el principal pendiente de la Semana 3 y constituye la prioridad técnica del sprint.
...
- [ ] Brechas críticas del backend atendidas.
